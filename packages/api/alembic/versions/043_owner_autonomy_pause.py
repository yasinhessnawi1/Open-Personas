...
Revision ID: 043_owner_autonomy_pause
Revises: 042_event_triggers

Renumbered at A6 merge-back (R-19-1): authored off ``038_initiative`` as a placeholder;
linearized onto main's real head ``042_event_triggers`` (A5→A7→N6→A11 landed between).
"""
...
revision = "043_owner_autonomy_pause"
down_revision = "042_event_triggers"
branch_labels = None
depends_on = None
