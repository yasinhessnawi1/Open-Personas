 ...
 *
 * HONESTY CONSTRAINT: the copy says only what is true. The owner-pause predicate is now injected
 * into EVERY origination path (A6-D-8 completeness, wired at merge-back): the A5 initiative scan,
 * the A7 event dispatcher, the A10 schedule tick, and the task-leg runner all consult it. So the
 * copy honestly says "stops all autonomy" — new initiatives, scheduled reminders, and event
 * reactions all halt, and running tasks stop at their next step (mid-step work finishes first).
 */
    ...
    <Card data-slot="owner-pause" data-paused={state.paused}>
      <CardContent className="flex flex-wrap items-center gap-3 p-4">
        <div className="flex min-w-0 flex-col gap-0.5">
          ...
          {/* honest scope — a pause now stops ALL origination (A6-D-8 completeness wired) */}
